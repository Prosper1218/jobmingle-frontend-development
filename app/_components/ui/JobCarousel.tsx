...
const JobCard: React.FC<JobCardProps> = ({ job }) => {
	...
	return (
		<div className="flex flex-col space-y-4 h-[420px]- h-auto ">
			...
			>
				<div className="flex flex-col space-y-4 card relative bg-white  shadow transition transform hover:scale-105 hover:shadow-2xl  shadow-yellow-500 p-2 md:p-3 rounded-md h-[350px] ">
