		...
		>
            ...
            pro."
					...
					<ServiceCard
						...
						n="2"
						aos="fade-up"
						description="To stand out in your niche, you must constantly seek ways to improve or add to your existing skillset. In today's world, having experience in one skill is no longer sufficient. You must look forward to acquiring skills that complement your existing abilities. At JobMingle, we offer a wide variety of digital courses that provide you with opportunities to advance your career with ease.
"
					/>
					<ServiceCard
						title="FREE REMOTE JOB LISTINGS"
						aostime="3000"
						aos="fade-right"
						n="3"
						description={`Posting remote job opportunities on JobMingle has never been easier. For recruiters looking to hire remote workers or freelancers, all you need to do is click the "GET STARTED"
						 button above and sign up as an employer. After listing your job, simply sit back and let JobMingle connect you with a pool of qualified candidates to choose from.`}
					/>
					...
					<div className="bg-white rounded-lg p-8 z-50 w-[90%] max-w-2xl max-h-[90vh] overflow-auto  shadow-lg">
						...
						<p className="text-lg leading-relaxed">
							...
							<div className="mt-2 flex items-center">
								WhatsApp/Call us here: 07077308481
								<a
