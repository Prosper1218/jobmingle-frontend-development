...
const AppHeader = () => {
	...
	return (
		...
		>
				...
				{user ? (
					...
					<div className="flex items-start gap-3 max-md:hidden ">
						<Link href="/sign-up" className="">
							<Button className=" bg-black text-white rounded-[10px]  hover:text-black hover:bg-yellow-500 transition-colors duration-500 w-[120px] ">
								Sign Up
							</Button>
						</Link>
						...
						<Link href="/sign-in">
							<Button className=" bg-white border-2 border-yellow-500 text-black rounded-[10px] hover:text-black hover:bg-yellow-500 w-[120px] transition-colors duration-500 max-md:hidden">
								Login
							</Button>
						</Link>
					</div>
			...
			{menuOpen && (
				<ul
					className={`bg-stone-800 md:hidden pb-10 absolute h-[50%] w-[100%] z-[2]   gap-[5px]  text-[#d9d9e8] flex flex-col justify-center items-center transition-colors duration-500 ${
						menuOpen
						...
						{user ? (
							...
							<div className="flex gap-2 ">
								<Link href="/sign-in" onClick={toggleMenu}>
									<Button className=" bg-white border-2 border-yellow-500 text-black rounded-[10px] hover:text-black hover:bg-yellow-500 w-[120px] transition-colors duration-500 ">
										Login
									</Button>
								</Link>
								<Link href="/sign-up" onClick={toggleMenu}>
									<Button className="w-[140px] bg-[#f5cb1a] text-black border-solid border-10 border-white transition-colors duration-300">
										Sign Up
									</Button>
								</Link>
							</div>
