...
const MyCourses = ({ searchQuery, link }: any) => {
	...
	if (courses === undefined || Courses === undefined) {
		return (
			<NoListings
				url="/dashboard/courses"
				title="You have not enrolled for any course yet! :)"
					...
					{Courses?.map((course: any) => (
						...
						>
							<div className="shadow shadow-yellow-500 p-2 md:p-3 rounded-md h-[100%] flex flex-col justify-center">
								<div className="grid grid-cols-2 h-[175px]   gap-4">
									{/* <div className="flex items-center border rounded">
										<Image
											...
											// className="w-full h-[9rem] md:h-[9rem] lg:h-[10rem] rounded "
											className="w-full h-[9rem] rounded "
											width={90}
											height={90}
										/>
									</div> */}
									...
									<div className="flex flex-col justify-between overflow-y-auto">
										<p className=" text-xs sm:text-[85%]  capitalize text-black font-bold py-0.5 ">
											{course.displayname}
										</p>
