...
import {useGetAuthUserQuery, useUpdateUserInfoMutation} from "@/app/_features/appSlices/apiSlice";
...
export default function UpdateUserInfo() {
   ...
   const [updateUserInfo, {isLoading: isUpdatingInfo, error}] = useUpdateUserInfoMutation();
   ...
   const style = "border-[#e5bb0a] border-[1px] border-solid h-[2rem] w-full rounded-sm sora pl-2 bg-transparent text-white text-[16px] focus:outline-none";

   return (
      <div>
         <form className="flex flex-col  gap-2 w-[80%] text-white md:w-auto" onSubmit={handleSubmit(handleUserInfoUpdate, onError)}>
            <div>
               <label className="text-sm montserrat tracking-wider font-medium">First Name</label>
               <input
                  type="text"
                  id="firstName"
                  className={style}
            ...
            <div>
               <label className="text-sm montserrat  tracking-wider font-medium">Last Name</label>
               <input
                  type="text"
                  id="lastName"
                  className={style}
            ...
            <div>
               <label className="text-sm montserrat  tracking-wider font-medium">Phone</label>
               <input
                  type="text"
                  id="phoneNumber"
                  className={style}
