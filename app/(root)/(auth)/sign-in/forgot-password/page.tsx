	...
	return (
		<main className="text-black min-h-screen- h-auto relative overflow-x-hidden">
			<div className="p-0 m-0 h-full flex flex-col sm:flex-row sm:justify-center relative overflow-x-hidden  py-3">
				<div className=" w-[90%] md:w-[50%] py-5 rounded  bg-[#FEFEFE] border shadow shadow-yellow-600 h-full- relative flex sm:justify-center flex-col mx-auto items-center mt-3   ">
					<div
						onClick={handleback}
