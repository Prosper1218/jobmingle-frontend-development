...
import ViewPassword from "@/app/_components/ui/VIewPassword";
	...
	return (
		<main className="text-black min-h-screen- h-auto relative overflow-x-hidden">
			...
			<div className="p-0 m-0 h-full flex flex-col sm:flex-row sm:justify-center relative overflow-x-hidden  py-3">
				<div className=" w-[90%] md:w-[50%] h-auto bg-[#FEFEFE]  flex sm:justify-center flex-col items-center mx-auto border rounded shadow shadow-yellow-600 ">
					<div
					...
					<h2 className="font-bold text-xl sm:text-2xl text-black-100 sora text-center mt-1 w-full px-4">
						Create new Password
					</h2>
					<p className="montserrat font-semibold text-sm text-black-100 w-full text-center px-2 md:px-4">
						Please enter the verification code sent to{" "}
						<strong>{resetEmail}</strong> and also provide a new unique password
						to gain access into your account!
					</p>

					{/* FORM */}
					<main className="relative min-w-[95%] sm:min-w-[70%] md:min-w-[90%] lg:min-w-[70%]  sm:mt-4 p-2 pb-8- flex flex-col">
						<form
