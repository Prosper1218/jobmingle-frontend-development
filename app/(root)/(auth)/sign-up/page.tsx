...
const Page = () => {
	...
	// 	try {
	// 		const res = await fetch("https://api.jobmingle.co/public/auth/google");
				...
				<div className=" w-full lg:w-[50%]  py-4 sm:py-12   bg-[#FEFEFE] sm:h-[100%] border flex  flex-col items-center ">
					...
					<main className="relative min-w-[95%] sm:min-w-[70%] md:min-w-[90%] lg:min-w-[70%] mt-7 sm:mt-2 p-2 pb-8 sm:pb-2 flex flex-col">
						<button
							...
							className="border-black-100 border-solid montserrat border-[1px] w-full h-[3rem] sm:h-[2.5rem] rounded-[10px] flex justify-center items-center gap-1 bg-transparent"
						>
