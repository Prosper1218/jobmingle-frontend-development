...
import {courseTags} from "@/lib/_exportLinks";
...
const CoursesPage = () => {
   ...
   return (
      <>
         <SearchBar searchQuery={searchQuery} setSearchQuery={setSearchQuery} title="Search your favorite course!" placeholder="Course title" icon={<HiBookOpen />} />
         <ScrollableTags setSearchQuery={setSearchQuery} tags={courseTags} />
