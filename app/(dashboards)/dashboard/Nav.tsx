		...
		>
			<ul className=" flex flex-row lg:flex-col md:gap-[0.2rem]  w-full justify-between lg:justify-between items-center lg:items-start md:overflow-y-auto h-full z-50">
				<li className="lg:w-full">
					...
					>
						<HiHome
							className={`text-inherit hover:text-yellow-500 w-[1.4rem] md:w-[1.8rem] h-[1.8rem] `}
						/>
				...
				<li className=" lg:w-full ">
					...
					>
						{/* <HiOutlineBookOpen */}
						<FaBookOpenReader
							className={`hover:text-yellow-500 text-stone-950- w-[1.4rem] md:w-[1.8rem] h-[1.8rem] text-inherit `}
						/>
